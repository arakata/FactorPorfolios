...
set(plot1(3),'MarkerSize',8,'Marker','square','LineStyle','-.',...
    'DisplayName','Plug-in MV');
set(plot1(4),'Marker','square','LineWidth',1.5,'Color',[0 0 1],...
    'DisplayName','Plug-in only risky assets');
set(plot1(5),'Marker','o','LineStyle','-.','Color',[1 0 0],...
    'DisplayName','Optimal plug-in MV');
set(plot1(6),'Marker','o','Color',[0 0 1],...
    'DisplayName','Optimal plug-in only risky assets');
set(plot1(7),'LineWidth',2.5,'LineStyle','-.',...
