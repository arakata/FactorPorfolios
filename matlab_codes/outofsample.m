...
% NOTE: we use T = M as an example, because we are considering the data we have. 
% Since the results are theoretical, we could use a different value for T that
% fullfil the conditions of the proposition  
